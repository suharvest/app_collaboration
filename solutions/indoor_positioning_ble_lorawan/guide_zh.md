...
1. 在设施中的战略位置放置 BLE 信标
2. 记录每个信标的 MAC 地址和安装位置
3. 如需要，使用 SenseCraft 应用配置信标
...
1. 打开 LoRaWAN 网关并连接互联网
2. 在 SenseCraft Data 或 ChirpStack 上注册网关
3. 验证网关在线状态
...
1. 激活 SenseCAP T1000 追踪器
2. 加入到您的 LoRaWAN 网络服务器
3. 启用 BLE 扫描模式
