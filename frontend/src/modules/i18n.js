  ...
  en: {
    ...
    devices: {
      ...
      restore: {
        ...
        watcherHint: 'Connect Watcher via USB, select port, then click restore. You will need to press the RESET button when prompted.',
  ...
  zh: {
    ...
    devices: {
      ...
      restore: {
        ...
        noPortsFound: '未找到串口',
        refreshPorts: '刷新串口',
        watcherHint: '通过 USB 连接 Watcher，选择串口后点击还原。系统会提示您按下 RESET 按钮。',
