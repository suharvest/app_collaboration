  ...
  en: {
    ...
    deploy: {
      ...
      docker: {
        ...
        fixAction: 'Fix Issue',
        replaceAction: 'Stop & Replace',
        existingContainers: 'Existing Containers Found',
        replaceHint: 'This will stop and remove the existing containers, then deploy the new version.',
        replacing: 'Stopping existing containers and redeploying...',
    ...
    devices: {
      ...
      configure: {
        ...
        desc: 'Update deployment parameters. Containers will restart to apply changes.',
        saving: 'Applying...',
        saved: 'Configuration updated, containers restarting',
        noFields: 'No configurable parameters for this application',
    ...
    settings: {
      ...
      apiAccess: {
        title: 'API Access',
        enable: 'Enable LAN API Access',
        enableDesc: 'Allow external programs to access this server over the local network',
        enabled: 'Enabled',
        disabled: 'Disabled',
        address: 'API Address',
        webModeHint: 'Use CLI flag --api-enabled or env PS_API_ENABLED=true to enable',
        restartRequired: 'Sidecar restart required to apply changes',
        ...
        keys: {
          ...
          empty: 'No API keys',
          emptyDesc: 'Create an API key to allow external access',
          createdAt: 'Created',
          lastUsed: 'Last Used',
          never: 'Never',
          copy: 'Copy',
  ...
  zh: {
    ...
    deploy: {
      ...
      docker: {
        ...
        fixAction: '修复问题',
        replaceAction: '停止并替换',
        existingContainers: '发现已有容器',
        replaceHint: '将停止并移除已有容器，然后部署新版本。',
        replacing: '正在停止已有容器并重新部署...',
    ...
    devices: {
      ...
      configure: {
        title: '配置应用参数',
        desc: '修改部署参数后，容器会自动重启以应用更改。',
        saving: '正在应用...',
        saved: '配置已更新，容器正在重启',
        noFields: '该应用没有可配置的参数',
        error: '配置更新失败',
      },
      connectFirst: '请先连接设备',
    ...
    settings: {
      ...
      apiAccess: {
        title: 'API 访问',
        enable: '启用局域网 API 访问',
        enableDesc: '允许外部程序通过局域网访问本服务器',
        enabled: '已启用',
        disabled: '已禁用',
        address: 'API 地址',
        webModeHint: '使用 CLI 参数 --api-enabled 或环境变量 PS_API_ENABLED=true 启用',
        restartRequired: '需要重启后端服务以生效',
        restarting: '重启中...',
        keys: {
          title: 'API 密钥',
          name: '密钥名称',
          ...
          create: '创建密钥',
          creating: '创建中...',
          created: '密钥已创建 — 请立即复制，此密钥不会再次显示',
          empty: '暂无 API 密钥',
          emptyDesc: '创建 API 密钥以允许外部访问',
          createdAt: '创建时间',
          lastUsed: '最后使用',
          never: '从未使用',
          copy: '复制',
